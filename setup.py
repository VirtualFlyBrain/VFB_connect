...
setup(name='vfb_connect',  # Required
      ...
      install_requires=['requests', 'pandas', 'jsonpath_rw', 'pysolr', 'navis', 'flybrains', 'numpy<2.0.0', 'neuprint-python', 'python-catmaid', 'matplotlib>3.9', 'seaborn>0.13', 'colormath', 'tqdm', 'vispy', 'ipywidgets'],
