...
class VFBTerm:
    ...
    def load_skeleton(self, template=None, verbose=False, query_by_label=True, force_reload=False, allow_multiple=False):
        ...
        template = self.get_default_template(template=template, verbose=verbose)
        print("Template: ", template) if verbose else None
    ...
    def get_default_template(self, template=None, verbose=False):
        """
        Get the default template for the term.
        """
        print("Getting default template for ", self.name) if verbose else None
        if template:
            print("Template provided: ", template) if verbose else None
            return self.vfb.lookup_id(template)
        else:
            print("No template provided") if verbose else None
        ...
        print("Default template failed ", template) if verbose else None
        return template
